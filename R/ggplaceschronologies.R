# ggplaceschronologies Funktion
# Vidualisiert Zeitmusterprofile data:
# (dplyr) data.frame, tbl oder
# Filterergebnis, das die zu
# visualisierenden Daten enthält.  map:
# (ggmap) Kartenausschnitt, für den die
# Orte Chronologie erstellt werden soll.
# day: (string) Tag, für den die Orte
# Chronologie erstellt werden soll.
# timepattern: (boolean) Gibt an, ob
# zusätzlich das Zeitmuster geplottet
# werden soll.  return (list) Eine Liste
# bestehend aus einer ggplot2 Grafik und
# der Legende als TableGrob.  Copyright
# © Fabian Mundt
