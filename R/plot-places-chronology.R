...
#'
#' @param data a data frame in correct form (columns: ID, day, duration, place, address, lon, lat, prop_duration).
#' @param id the ID to plot. 
#' @param map a ggmap map object.
#' @param weekday specify the weekday to plot.
#' @param time_pattern whether to plot or not to plot time pattern graph.
#' @param size_range specify the size for visualizatipn of duration. 
#' @param shape_path specify the shape of the path line. Higher values result in 'rounder' paths.
...
#' @param axis_labels show or hide axis labels (boolean).
