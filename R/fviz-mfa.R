...
#' \item{fviz_mfa_biplot(): Biplot of individuals and qualitative variables}
...
#' @rdname fviz_mfa
#' @export
#@todo Optimieren, um Codeduplizierung zu vermeiden!
fviz_mfa_quanti_var <- function(X, axes=c(1,2), geom=c("point", "text"), label="all",  invisible ="none",
